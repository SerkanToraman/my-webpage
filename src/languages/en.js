...
export const enText = {
  ...
  mainHeader2 :"Continuous Learner",
  shortIntroduction:"Hi, I’m Serkan. I’m a full-stack developer. If you are looking for a Developer who to craft a solid product that all the parts are taken care of and a product that will impress the end user, let’s shake hands.",
  skillDescription1:"I have completed over 20 project in which I have made use of redux, middleware, context API's, custom hooks, localstorage, axios, react-hook-form, react-router-dom, cypress libraries",
  skillDescription2:"I have a deep understanding in Express, knex, sqlite3, dotenv, cors, redis, jsonwebtoken, bcryptjs, jest, nodemon libraries. Additionally, I have a deep knowledge in REST protocol.",
  ...
  projectName2:"Twitter Project",
  projectDescription2:"This project emcompasses the both backend and frontend coding. ReactJS library for front-end and NodeJS back-end service are applied to code the project. Additionally, SCSS languguage is used for the stying. The project is live and you can send a tweet.  ",
